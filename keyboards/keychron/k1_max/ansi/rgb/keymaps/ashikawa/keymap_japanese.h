...
#define ALT_KANA ALT_T(KC_LNG4)
#define ALT_EISU ALT_T(LSFT(KC_INT5))
#define ALT_HENK ALT_T(KC_INT4)
#define ALT_MHEN ALT_T(KC_INT5)

#define ALT_MEISU  ALT_T(KC_LNG2) // 単押しで英数、長押しでAlt
#define ALT_MKANA  ALT_T(KC_LNG1) // 単押しでかな、長押しでAlt
